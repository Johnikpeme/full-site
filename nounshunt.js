...
hamburger.addEventListener('click', () => {
    ...
    navLinks.style.backgroundColor = navLinks.classList.contains('active') ? '#FFFFFF' : 'transparent';
});
...
const mainContent = createElement('main', { backgroundColor: '#FFFFFF', padding: '0 0 5vh' });
...
const nounsHuntLogo = createElement('img', {
    height: 'auto',
    display: 'block'
}, {
...
const gameDescription = createElement('p', {
...
const overviewTitle = createElement('h2', {
    fontSize: '4vw',
    color: '#000000',
    textAlign: 'center',
    marginBottom: '4vh',
...
const steps = [
    ...
    { text: 'Play "Private" with friends or "Public" to compete online', img: 'screenshot2.png' },
    { text: 'Host or Join Game', img: 'screenshot3.png' },
    { text: 'Setup your game by choosing from a list of expanding categories', img: 'screenshot4.png' },
...
function updateSlider() {
    ...
    const stepImage = createElement('img', {
        width: '40vh',
        height: 'auto',
        borderRadius: '1vw',
...
const rankingsTitle = createElement('h2', {
    fontSize: '4vw',
    color: '#000000',
    marginBottom: '4vh',
    textTransform: 'uppercase'
...
const singleplayerTitle = createElement('h3', {
    fontSize: '2.5vw',
    color: '#000000',
    marginBottom: '2vh',
    textTransform: 'uppercase'
...
const spHeaders = ['Rank', 'Player', 'Score'].map(text => 
    createElement('th', { padding: '1vh', borderBottom: '0.2vh solid #333', color: '#301934' }, {}, [text])
);
...
const multiplayerTitle = createElement('h3', {
    fontSize: '2.5vw',
    color: '#000000',
    marginBottom: '2vh',
    textTransform: 'uppercase'
...
function updateRankings() {
    fetch('https://your-api-endpoint/singleplayer')
        ...
        .then(data => {
            ...
            data.slice(0, 10).forEach((player, index) => {
                ...
                const rank = createElement('td', { padding: '1vh', borderBottom: '0.1vh solid #ccc' }, {}, [String(index + 1)]);
                const name = createElement('td', { padding: '1vh', borderBottom: '0.1vh solid #ccc' }, {}, [player.name]);
                const score = createElement('td', { padding: '1vh', borderBottom: '0.1vh solid #ccc' }, {}, [String(player.score)]);
                row.append(rank, name, score);
                tbody.append(row);
            });
        })
        .catch(error => console.error('Error fetching Singleplayer rankings:', error));

    fetch('https://your-api-endpoint/multiplayer')
        .then(response => response.json())
        .then(data => {
        ...
        .catch(error => console.error('Error fetching Multiplayer rankings:', error));
}
...
mainContent.append(heroSection, gameInfoSection, gameOverviewSection, rankingsSection, newsSection);
...
video.addEventListener('canplaythrough', () => {
    video.play().catch(error => console.error('Video failed to autoplay:', error));
});
...
const email = createElement('p', { fontSize: '1.4vw', margin: '0.5vh 0', color: '#FFFFFF' }, {}, ['All Rights Reserved']);
const copyright = createElement('p', { fontSize: '1.4vw', margin: '0.5vh 0', color: '#FFFFFF' }, {}, ['© 2025 Dash Studios Inc.']);
